...
from canonicalize_term_full_Recursive_normalization_with_Fun_formula import canonicalize_term



Formulas_dir = "D:\\MECH-DNN PAPER\\VC SIR PAPER\\SRA_EQUATION\\Equation Terms_upadate\\Set of formula\\formulas_txt"
formulas = []
...
plt.tight_layout()
plt.savefig('D:\\MECH-DNN PAPER\\VC SIR PAPER\\SRA_EQUATION\\Equation Terms_upadate\\Set of formula\\formulas_txt\\Comman_Terms\\term_counts_with_consider_coeff.png')
#plt.show()
...
plt.ylabel('Frequency')
plt.tight_layout()
plt.savefig('D:\\MECH-DNN PAPER\\VC SIR PAPER\\SRA_EQUATION\\Equation Terms_upadate\\Set of formula\\formulas_txt\\Comman_Terms\\term_counts_without_consider_coeff.png')
#plt.show()
